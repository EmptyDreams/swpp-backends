...
declare const UPDATE_JSON_URL: string
declare const UPDATE_CD: number
declare const VERSION_PATH: string

declare const readVersion: () => Promise<BrowserVersion | undefined>
declare const writeVersion: (version: BrowserVersion) => Promise<void>
declare const postMessage: (type: string, data: any, ...goals: any) => Promise<void>
declare const markCacheInvalid: (request: RequestInfo | URL) => Promise<void>
declare const isBlockRequest: (request: Request) => boolean
declare const modifyRequest: (request: Request) => Request | null | undefined
declare const normalizeUrl: (url: string) => string
declare const matchCacheRule: (url: URL) => undefined | null | false | number | symbol
declare const matchFromCaches: (request: RequestInfo | URL) => Promise<Response | undefined>
declare const isValidCache: (response: Response, rule: number | false | null | undefined | symbol) => boolean
declare const fetchFile: (request: RequestInfo | URL, optional?: RequestInit) => Promise<Response>
...
declare const matchUpdateRule: (change: UpdateChangeExp) => ((url: string) => boolean|undefined|null)
